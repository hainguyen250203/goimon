...
/**
 * Chặn đóng ca nếu còn đơn "open"/"printed" chưa xử lý xong — tránh tình
 * trạng bàn còn đơn dở mà ca đã đóng, dữ liệu đối soát doanh thu sai lệch.
 * Chỉ 1 ca mở tại 1 thời điểm nên mọi đơn đang active đều thuộc ca này.
 */
