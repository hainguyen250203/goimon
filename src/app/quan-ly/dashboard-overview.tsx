...
import { Armchair, CheckCircle2, Clock, HandCoins, PiggyBank, Wallet, XCircle } from "lucide-react";
    ...
    <Flex direction="column" gap={5}>
      ...
      >
        ...
        <KpiCard
          ...
          value={formatVnd(latestShift.totalRevenue + latestShift.openRevenue)}
